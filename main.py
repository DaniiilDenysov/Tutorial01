...
Original file is located at
    https://colab.research.google.com/drive/1rtD4lV8K0sxCZHdBITKMEFrta7zhdaSn
...
# Print a personalized greeting message
print("Hello,", " Mr./Ms. ", surname,  " ", name, " ", " you are ", age, " years old!")
